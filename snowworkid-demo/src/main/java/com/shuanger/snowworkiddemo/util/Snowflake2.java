package com.shuanger.snowworkiddemo.util;
...
public class Snowflake2 {
    ...
    private static volatile Snowflake2 snowflake = null;
    ...
    //单例禁止new实例化
    private Snowflake2(long workerId, long dataCenterId) {
     ...
     * @return
     */
    public static Snowflake2 getInstanceSnowflake() {
        synchronized (lock) {
             if (snowflake == null) {
                long workerId ;
                ...
                snowflake = new Snowflake2(workerId, dataCenterId);
            }
        }
        return snowflake;
    }
    ...
    public static String getSnowflakeId() {
        String s = "";
        try {
            s = String.valueOf(Snowflake2.getInstanceSnowflake().nextId());
        } catch (Exception e) {
            throw new BusinessException("雪花算法出现异常");
        }
        return s;
    }
